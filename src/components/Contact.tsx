  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white w-full">
      <div className="flex flex-col lg:flex-row min-h-screen w-full">
        ...
        <div className="lg:w-1/2 relative bg-gradient-to-r from-purple-600 to-indigo-600 p-8 lg:p-12">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">123 Business Avenue, Silicon Valley, CA 94043</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">support@bookingapp.com</p>
                  </div>
                </div>
        ...
        <div className="lg:w-1/2 flex items-center justify-center p-8 lg:p-12">
          <div className="w-full max-w-md">
            ...
            {submitted ? (
              <div className="bg-green-50 text-green-500 px-4 py-3 rounded-lg mb-6">
